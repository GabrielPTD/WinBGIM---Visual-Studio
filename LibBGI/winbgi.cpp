...
#include "winbgi.hpp"             // External API routines
#include "winbgitypes.hpp"        // Internal structures and routines
...
{
    static char msg[16][128] = { "No error", "Graphics not installed",
